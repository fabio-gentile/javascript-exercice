...
const poolSharing = [
  ...
  { number: 4, star: 0, share: 1.3, chance: 20720 },
  { number: 3, star: 2, share: 0.37, chance: 10360 },
  { number: 3, star: 1, share: 1.45, chance: 1280 },
  { number: 3, star: 0, share: 2.7, chance: 320 },
  { number: 2, star: 1, share: 10.3, chance: 49 },
...
formSubmit.addEventListener('click', (balance) => {
  ...
  if (actualCombination.share === 0) {
    ...
    const numberOfPlayers = Math.floor(pool / actualCombination.chance)
    const poolShareCombination = pool * (actualCombination.share / 100)
